...
import zonsim.tangjunwei.demo.R;
...
public class AVLoadingIndicatorView extends View {
    ...
    private static final Indicator DEFAULT_INDICATOR = new ClockLoadingIndicatorView();
    ...
    private void init(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        ...
        mIndicatorColor = a.getColor(R.styleable.AVLoadingIndicatorView_indicatorColor, Color.GRAY);
